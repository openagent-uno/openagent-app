 ...
 *
 * Opens on the graph dashboard (``index``). Tapping a graph node pushes
 * the editor onto this stack as ``[...path]`` — catch-all so note paths
 * with folder segments (``docs/ideas.md``) work as-is.
 *
